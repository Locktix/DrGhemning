  ...
  return (
    <>
      ...
      <Container maxWidth="md" sx={{ mt: 8 }}>
        ...
        <UserManager />
        <Box sx={{ mt: 6, p: 3, bgcolor: 'rgba(33,150,243,0.05)', borderRadius: 3, border: '1px solid rgba(33,150,243,0.2)' }}>
          <Typography variant="h6" gutterBottom sx={{ color: 'primary.main', fontWeight: 600 }}>
            Gestion des médecins pour les prises de sang
          </Typography>
          <Box component="form" onSubmit={handleAddMedecin} sx={{ display: 'flex', gap: 2, mb: 3, flexWrap: 'wrap' }}>
          ...
          <TableContainer component={Paper} sx={{ borderRadius: 3, boxShadow: 3, bgcolor: 'rgba(236,239,241,0.7)', mt: 2, maxWidth: 500 }}>
            <Table>
              <TableHead>
                  ...
                  <Fade in={true} timeout={500 + i * 120} key={medecin.id}>
                    <TableRow>
                      ...
                      <TableCell align="right">
                        ...
                        <IconButton onClick={() => handleDeleteMedecin(medecin.id)} sx={{ color: '#d32f2f' }}>
                          <DeleteIcon />
                        </IconButton>
                      </TableCell>
                    </TableRow>
